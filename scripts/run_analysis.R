...
if (!file.exists("./data/Dataset.zip")){
  ...
  download.file(urlsmartphone, destfile = "./data/Dataset.zip")
}
...
write.table(test_train, "./data/UCI HAR Dataset/test_train.txt",
            row.name = FALSE)
...
write.table(test_train2, "./data/UCI HAR Dataset/test_train2.txt", row.name = FALSE)
